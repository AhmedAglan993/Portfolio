    ...
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden pt-16">
      ...
      <div className="container mx-auto px-6 z-10 relative text-center">
        <div className="inline-block mb-4 px-4 py-1 border border-neon-blue/50 rounded-full bg-neon-blue/5 backdrop-blur-sm">
          <span className="text-neon-blue font-mono text-sm tracking-widest">AVAILABLE FOR CONTRACTS</span>
        </div>
        ...
        <p className="text-lg md:text-xl text-gray-400 max-w-2xl mx-auto mb-10 leading-relaxed font-light">
          Hi, I'm <strong className="text-white">Ahmed Aglan</strong>.
          A freelance VR/AR Developer with 10 years of experience leading teams and delivering full-lifecycle immersive experiences.
        </p>
        ...
        <div className="mt-24 grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto opacity-70">
          ...
          <div className="p-4 border-l-2 border-neon-green/50 bg-black/30">
            ...
            <div className="text-xs text-gray-400 uppercase tracking-wider">Years as Lead</div>
          </div>
          <div className="p-4 border-l-2 border-white/50 bg-black/30">
            <div className="text-2xl font-mono font-bold text-white">100%</div>
            <div className="text-xs text-gray-400 uppercase tracking-wider">Commitment</div>
          </div>
        </div>
      </div>
    </section>
